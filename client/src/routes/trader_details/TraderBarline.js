...
const Chart1Defs = createG2((chart, data) => {
    ...
    chart.line().position('t_time*amount_acc').color('#94e08a').size(3).opacity(0.8).tooltip('t_time*amount_acc');
...
const Chart2Defs = createG2((chart, data) => {
    ...
    chart.line().position('t_time*data_i').color('#94e08a').size(3).opacity(0.8).tooltip('t_time*data_i');
