...
//  chart.legend('amount', false);
  ...
  chart.point().position('started_at*trader_name').color('status_desc').size('gross_margin', 10, 2).opacity(0.9).shape('control_element', ['circle', 'triangle', 'diamond']).tooltip('started_at*trader_name*order_no*control_element*status_desc*amount*gross_margin');
