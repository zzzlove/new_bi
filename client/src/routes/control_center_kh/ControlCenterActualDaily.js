...
query MyQuery($control_center_id: [Int], $control_element: [String], $t_time: [Float]) {
  dataSource: control_center_actual(control_center_id: $control_center_id, control_element: $control_element, t_time: $t_time, type:["city_inc2nd","line_inc2nd","service_inc2nd","region_inc2nd"],record_type:"daily", order: ["t_run"]) {
    id
    t_run
    type
    t_time
...
export default graphql(QueryToRender, {
  options: (props) => ({ variables: { control_center_id: props.control_center_id, control_element: props.control_element, t_time: props.t_time } }),
})(RenderComponent);
