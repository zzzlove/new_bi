...
query MyQuery($control_center_id: [Int]) {
  chart_title_one(code: "KH_WTFT01"){show_title}
  title: chart_data_one(chart_no: "WTFT01", control_center_id: $control_center_id){control_center}
  dataSource: chart_data(chart_no: "WTFT01", control_center_id: $control_center_id, order: ["t_run"]) {
    id
    t_run
    cat_1st
    count 
