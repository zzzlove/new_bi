...
query MyQuery($control_center_id: [Int]) {
  chart_title_one(code: "KH_MTIT01_2"){show_title}
  title: control_center_actual_one(type:["city_cus","line_cus","service_cus","region_cus","linegr_cus"], record_type:"weekly", data_set: "byCusLevel", control_center_id: $control_center_id){control_center}
  dataSource: control_center_actual(type:["city_cus","line_cus","service_cus","region_cus","linegr_cus"], record_type:"weekly", data_set: "byCusLevel", control_center_id: $control_center_id, order: ["t_run"]) {
    id
    t_run
    control_element
    amount
