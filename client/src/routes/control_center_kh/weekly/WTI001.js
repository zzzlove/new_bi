...
query MyQuery($control_center_id: [Int]) {
  chart_title_one(code: "KH_WTI001"){show_title}
  title: control_center_actual_one(type:["city_inc","line_inc","service_inc","region_inc"],record_type:"weekly", control_element: "总计",
    control_center_id: $control_center_id){control_center}
  dataSource: control_center_actual(type:["city_inc","line_inc","service_inc","region_inc"],record_type:"weekly", control_element: "总计",control_center_id: $control_center_id, order: ["t_run"]) {
    id
    control_center_id
    t_run
    type
