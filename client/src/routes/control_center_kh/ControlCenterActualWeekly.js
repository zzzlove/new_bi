...
query MyQuery($control_center_id: [Int], $t_run: String) {
  dataSource: control_center_actual(control_center_id: $control_center_id, t_run: $t_run, type:["city_inc2nd","line_inc2nd","service_inc2nd","region_inc2nd"],record_type:"weekly",) {
    id
    t_run
    type
    t_time
