...
const Chart1Defs = createG2((chart, data) => {
    ...
    chart.intervalDodge().position('t_run*count_distinct').color('control_center').tooltip('*control_center*count*amount*count_distinct')
...
query MyQuery($id: ID, $control_center_pid: Int, $control_element: [String]) {
  chart_title_one(code: "KH_MTTS01"){show_title}
