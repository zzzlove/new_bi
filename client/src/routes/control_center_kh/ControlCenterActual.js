...
class RenderComponent extends React.Component {
 ...
 render() {
  ...
  const { loading, error, dataSource, variables } = this.props.data; 
...
query MyQuery($control_center_id: [Int], $t_run: String, $type: [String], $record_type: [String], $data_set: String, $t_time: [Float]) {
  dataSource: control_center_actual(control_center_id: $control_center_id, t_run: $t_run, type:$type, record_type: $record_type, data_set: $data_set, t_time: $t_time) {
    id
    t_run
    type
    t_time
...
export default graphql(QueryToRender, {
  options: (props) => ({ variables: { control_center_id: props.control_center_id, t_run: props.t_run, type: props.type, record_type: props.record_type, data_set: props.data_set, t_time: props.t_time } }),
})(RenderComponent);
