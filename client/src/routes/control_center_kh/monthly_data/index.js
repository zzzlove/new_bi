...
import ControlCenterActualMonthly from '../ControlCenterActualMonthly';
...
function RenderComponent ({ control_center_kh_monthly_data,  data }) {
  ...
  const {id, t_run, type, record_type, data_set} = control_center_kh_monthly_data;
  
  console.log(control_center_kh_monthly_data);
  ...
  return (
     <div>
     <ControlCenterActual control_center_id={id} t_run={t_run} type={type} record_type={record_type}/>
