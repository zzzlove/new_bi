...
query MyQuery($ops_id: [Int!]) {
  sales_yd_amount_in_cm_gb_day(ops_id: $ops_id){x, y}
  sales_yd_amount_in_p12m_gb_month(ops_id: $ops_id){x, y}
  sales_yd_tradercount_in_p12m_gb_month(ops_id: $ops_id){x, y}
  sales_yd_tradercount_in_currentyear(ops_id: $ops_id)
  sales_yd_tradercount_in_lastyear(ops_id: $ops_id)
  sales_yd_amount_ytd_in_currentyear(ops_id: $ops_id)
  sales_yd_amount_ytd_in_lastyear(ops_id: $ops_id)
}
`;
...
query MyQuery($ops_id: [Int!], $mode: String!, $started_at: String!, $finished_at: String!) {
  sales_yd_amount_range_gb_depart_dest(ops_id: $ops_id, mode: $mode, started_at: $started_at, finished_at: $finished_at){c, y}
  sales_yd_amount_range_gb_tradername(ops_id: $ops_id, mode: $mode, started_at: $started_at, finished_at: $finished_at){c, y}
  sales_yd_amount_range_gb_tradercode_mode(ops_id: $ops_id, mode: $mode, started_at: $started_at, finished_at: $finished_at){x,c,y1, y2}
}
`;
