...
function RenderComponent({data}) {
   ...
   const { loading, error, dataSource } = data;
      ...
      /*
     <Button onClick={() => openNewLink(`service_no_kh_details?service_no=${record.SubCenter.name}`)}>运单看板 <Icon style={{marginLeft:'1px', padding:'1px', fontSize: 12}} type="dot-chart"/></Button>
     */
